    ...
    <PageDefault>
      <Container>
        <Content>
          ...
          <h1 className="typing-animation">Hello, My name is Wesley👋</h1>
          <Info>
            <Content>
              ...
              <Painel>
                <p>
                  Graduated in Systems Analysis and Development, acting as a
                  Full Front-end Developer. On a journey of learning and
                  continuous improvement, seeking to improve myself every day in
                  development practices and studying the DevOps culture.
                </p>
                <h3>🚀 Currently doing Reckeatseat Bootcamp focusing on technologies:</h3>
                <ul>
                  <li>Nodejs</li>
                  <li>Nextjs</li>
                  <li>React</li>
